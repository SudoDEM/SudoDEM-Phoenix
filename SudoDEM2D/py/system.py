...
def cxxCtorsDict(proxyNamespace=__builtins__):
	...
	Root classes are those that are directly wrapped by pybind11. These are only put to the dict.
...
# consistency check
# With the new ClassRegistry system, classes are registered directly in sudodemWrapper.cpp
# and may not appear in ClassFactory immediately. Skip this check for the new system.
