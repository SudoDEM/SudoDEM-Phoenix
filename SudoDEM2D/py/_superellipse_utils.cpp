...
void pybind_init__superellipse_utils(pybind11::module& m){
	...
	m.def("NewSuperellipse", NewSuperellipse,
		pybind11::arg("x"),
		pybind11::arg("y"),
		pybind11::arg("ep"),
		pybind11::arg("mat"),
		pybind11::arg("rotate"),
		pybind11::arg("isSphere"),
		pybind11::arg("z_dim")=1.0,
		"Generate a Superellipse.");
  m.def("NewSuperellipse_rot", NewSuperellipse_rot,
		pybind11::arg("x"),
		pybind11::arg("y"),
		pybind11::arg("ep"),
		pybind11::arg("mat"),
		pybind11::arg("miniAngle"),
		pybind11::arg("isSphere"),
		pybind11::arg("z_dim")=1.0,
		"Generate a Super-ellipsoid with parameters x, y, ep, .");
	m.def("outputParticles", outputParticles, "output particle info(rx,ry,eps,x,y,rotation angle) to a text file.");
	// Register drawSVG - Vector3r default arguments removed (causes import hang)
	m.def("drawSVG", drawSVG,
		pybind11::arg("filename"),
		pybind11::arg("width_cm")=10.0,
		pybind11::arg("slice")=20,
		pybind11::arg("line_width")=0.1,
		pybind11::arg("fill_opacity")=0.5,
		pybind11::arg("draw_filled")=true,
		pybind11::arg("draw_lines")=true,
		pybind11::arg("color_po")=false,
		pybind11::arg("po_color"),
		pybind11::arg("solo_color"),
		pybind11::arg("force_line_width")=0.001,
		pybind11::arg("force_fill_opacity")=0,
		pybind11::arg("force_line_color"),
		pybind11::arg("draw_forcechain")=false,
		"draw Superellipses into a svg file.");
	//m.def("outputPOV",outputPOV,"output Superellipse into a POV file for post-processing using POV-ray.");
  //m.def("outputVTK",outputVTK,"output Superellipse into a VTK file for post-processing using Paraview.");
}
