...
class Functor: public Serializable
{
	...
	virtual void pyRegisterClass(pybind11::module_ _module) {
		...
		// Register attributes
		_classObj.def_readwrite("label", &Functor::label, "Textual label for this object; must be a valid python identifier, you can refer to it directly from python.");
		// Python-specific properties
		_classObj.def_readonly("timingDeltas", &Functor::timingDeltas, "Detailed information about timing inside the Dispatcher itself. Empty unless enabled in the source code and O.timingEnabled==True.");
		_classObj.def_property_readonly("bases", &Functor::getFunctorTypes, "Ordered list of types (as strings) this functor accepts.");
	}
};
			...
			public FunctorWrapper<_ReturnType, _ArgumentTypes>
{
	public:
		...
		#define FUNCTOR1D(type1) public: std::string get1DFunctorType1(void) override{return string(#type1);} int checkArgTypes(const shared_ptr<DispatchType1>& arg1){ return (bool)SUDODEM_PTR_DYN_CAST<type1>(arg1)?1:0; }
			...
			public FunctorWrapper<_ReturnType, _ArgumentTypes>
{
	public:
		...
		#define FUNCTOR2D(type1,type2) public: std::string get2DFunctorType1(void) override{return string(#type1);}; std::string get2DFunctorType2(void) override{return string(#type2);}; int checkArgTypes(const shared_ptr<DispatchType1>& arg1, const shared_ptr<DispatchType2>& arg2){ if(SUDODEM_PTR_DYN_CAST<type1>(arg1)&&SUDODEM_PTR_DYN_CAST<type2>(arg2)) return 1; if(SUDODEM_PTR_DYN_CAST<type1>(arg2)&&SUDODEM_PTR_DYN_CAST<type2>(arg1)) return -1; return 0; }
