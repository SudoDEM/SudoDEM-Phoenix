...
#define REGISTER_CLASS_INDEX(SomeClass,BaseClass)                                      \
	...
	public: virtual int& getBaseClassIndex(int depth) override {              \
		static std::unique_ptr<BaseClass> baseClass(new BaseClass); \
