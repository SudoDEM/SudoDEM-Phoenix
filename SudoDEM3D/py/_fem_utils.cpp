...
void pybind_init__fem_utils(pybind11::module& m){
    ...
    m.def("NewMembrane", NewMembrane, "creat a membrane element with three nodes.");
    m.def("CylindricalWall", CylindricalWall, "creat a membrane element with three nodes.");
}
