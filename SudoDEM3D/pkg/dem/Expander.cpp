...
// pyRegisterClass implementation moved from Expander.hpp
void Expander::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Expander");
	pybind11::class_<Expander, BoundaryController, std::shared_ptr<Expander>> _classObj(_module, "Expander", "An engine to expand polySuperEllipsoids.");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("initExpandAlpha", &Expander::initExpandAlpha, "Initial expansion alpha value");
	_classObj.def_readwrite("expandSlice", &Expander::expandSlice, "Number of expansion slices");
	_classObj.def_readwrite("preExpandAlpha", &Expander::preExpandAlpha, "Pre-expansion alpha value");
	_classObj.def_readwrite("cycleInterval", &Expander::cycleInterval, "Interval for cycling");
}
