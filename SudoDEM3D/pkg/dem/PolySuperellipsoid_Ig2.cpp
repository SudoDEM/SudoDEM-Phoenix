...
#include <sudodem/pkg/dem/PolySuperellipsoid_Ig2.hpp>
...
// pyRegisterClass implementations moved from PolySuperellipsoid_Ig2.hpp
void Ig2_PolySuperellipsoid_PolySuperellipsoid_PolySuperellipsoidGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_PolySuperellipsoid_PolySuperellipsoid_PolySuperellipsoidGeom");
	pybind11::class_<Ig2_PolySuperellipsoid_PolySuperellipsoid_PolySuperellipsoidGeom, IGeomFunctor, std::shared_ptr<Ig2_PolySuperellipsoid_PolySuperellipsoid_PolySuperellipsoidGeom>> _classObj(_module, "Ig2_PolySuperellipsoid_PolySuperellipsoid_PolySuperellipsoidGeom", "Create/update geometry of collision between 2 PolySuperellipsoids");
	_classObj.def(pybind11::init<>());
}

void Ig2_Wall_PolySuperellipsoid_PolySuperellipsoidGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_Wall_PolySuperellipsoid_PolySuperellipsoidGeom");
	pybind11::class_<Ig2_Wall_PolySuperellipsoid_PolySuperellipsoidGeom, IGeomFunctor, std::shared_ptr<Ig2_Wall_PolySuperellipsoid_PolySuperellipsoidGeom>> _classObj(_module, "Ig2_Wall_PolySuperellipsoid_PolySuperellipsoidGeom", "Create/update geometry of collision between Wall and PolySuperellipsoid");
	_classObj.def(pybind11::init<>());
}

void Ig2_Facet_PolySuperellipsoid_PolySuperellipsoidGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_Facet_PolySuperellipsoid_PolySuperellipsoidGeom");
	pybind11::class_<Ig2_Facet_PolySuperellipsoid_PolySuperellipsoidGeom, IGeomFunctor, std::shared_ptr<Ig2_Facet_PolySuperellipsoid_PolySuperellipsoidGeom>> _classObj(_module, "Ig2_Facet_PolySuperellipsoid_PolySuperellipsoidGeom", "Create/update geometry of collision between Facet and PolySuperellipsoid");
	_classObj.def(pybind11::init<>());
}
