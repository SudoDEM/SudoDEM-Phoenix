...
REGISTER_CLASS_INDEX_CPP(RolFrictMat,FrictMat)
REGISTER_CLASS_INDEX_CPP(RolFrictPhys,FrictPhys)
...
// pyRegisterClass implementation moved from RollingResistanceLaw.hpp
void RolFrictMat::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("RolFrictMat");
	pybind11::class_<RolFrictMat, FrictMat, std::shared_ptr<RolFrictMat>> _classObj(_module, "RolFrictMat", "Material for rolling resistance.");
	...
	_classObj.def(pybind11::init([](std::string label, Real Kn, Real Ks, Real frictionAngle, Real density) {
		auto mat = std::make_shared<RolFrictMat>();
		mat->label = label;
		mat->Kn = Kn;
		mat->Ks = Ks;
		...
		mat->density = density;
		return mat;
	}), pybind11::arg("label")="", pybind11::arg("Kn")=1e7, pybind11::arg("Ks")=1e7, pybind11::arg("frictionAngle")=0.5, pybind11::arg("density")=2650);
	_classObj.def_readwrite("Kn", &RolFrictMat::Kn, "Normal contact stiffness [N/m].");
	_classObj.def_readwrite("Ks", &RolFrictMat::Ks, "Tangential contact stiffness [N/m].");
	_classObj.def_readwrite("alphaKr", &RolFrictMat::alphaKr, "Dimensionless rolling stiffness.");
	_classObj.def_readwrite("alphaKtw", &RolFrictMat::alphaKtw, "Dimensionless twist stiffness.");
	_classObj.def_readwrite("etaRoll", &RolFrictMat::etaRoll, "Dimensionless rolling (aka 'bending') strength. If negative, rolling moment will be elastic.");
	_classObj.def_readwrite("etaTwist", &RolFrictMat::etaTwist, "Dimensionless twisting strength. If negative, twist moment will be elastic.");
}

void RolFrictPhys::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("RolFrictPhys");
	pybind11::class_<RolFrictPhys, FrictPhys, std::shared_ptr<RolFrictPhys>> _classObj(_module, "RolFrictPhys", "Physics for rolling resistance.");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("kr", &RolFrictPhys::kr, "rotational stiffness [N.m/rad]");
	_classObj.def_readwrite("ktw", &RolFrictPhys::ktw, "twist stiffness [N.m/rad]");
	_classObj.def_readwrite("maxRollPl", &RolFrictPhys::maxRollPl, "Coefficient of rolling friction (negative means elastic).");
	_classObj.def_readwrite("maxTwistPl", &RolFrictPhys::maxTwistPl, "Coefficient of twisting friction (negative means elastic).");
	_classObj.def_readwrite("creep_viscosity", &RolFrictPhys::creep_viscosity, "creep viscosity [Pa.s/m].");
	_classObj.def_readonly("moment_twist", &RolFrictPhys::moment_twist, "Twist moment");
	_classObj.def_readonly("moment_bending", &RolFrictPhys::moment_bending, "Bending moment");
}

void RollingResistanceLaw::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("RollingResistanceLaw");
	pybind11::class_<RollingResistanceLaw, LawFunctor, std::shared_ptr<RollingResistanceLaw>> _classObj(_module, "RollingResistanceLaw", "Law for linear traction-compression-bending-twisting, with cohesion+friction and Mohr-Coulomb plasticity surface.");
	_classObj.def(pybind11::init<>());
	_classObj.def(pybind11::init<bool>(), pybind11::arg("use_rolling_resistance"));
	_classObj.def_readwrite("momentRotationLaw", &RollingResistanceLaw::momentRotationLaw, "If true, use bending/twisting moments at contacts.");
	_classObj.def_readwrite("traceEnergy", &RollingResistanceLaw::traceEnergy, "Define the total energy dissipated in plastic slips");
	_classObj.def_readwrite("use_rolling_resistance", &RollingResistanceLaw::use_rolling_resistance, "If true, use rolling resistance at contacts.");
	_classObj.def("normElastEnergy", &RollingResistanceLaw::normElastEnergy, "Compute normal elastic energy.");
	_classObj.def("shearElastEnergy", &RollingResistanceLaw::shearElastEnergy, "Compute shear elastic energy.");
	_classObj.def("bendingElastEnergy", &RollingResistanceLaw::bendingElastEnergy, "Compute bending elastic energy.");
	_classObj.def("twistElastEnergy", &RollingResistanceLaw::twistElastEnergy, "Compute twist elastic energy.");
	_classObj.def("elasticEnergy", &RollingResistanceLaw::totalElastEnergy, "Compute total elastic energy.");
	_classObj.def("getPlasticDissipation", &RollingResistanceLaw::getPlasticDissipation, "Get plastic dissipation.");
	_classObj.def("initPlasticDissipation", &RollingResistanceLaw::initPlasticDissipation, "Initialize plastic dissipation.");
}

void Ip2_RolFrictMat_RolFrictMat_RolFrictPhys::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ip2_RolFrictMat_RolFrictMat_RolFrictPhys");
	pybind11::class_<Ip2_RolFrictMat_RolFrictMat_RolFrictPhys, IPhysFunctor, std::shared_ptr<Ip2_RolFrictMat_RolFrictMat_RolFrictPhys>> _classObj(_module, "Ip2_RolFrictMat_RolFrictMat_RolFrictPhys", "Generates cohesive-frictional interactions with moments.");
	_classObj.def(pybind11::init<>());
}
