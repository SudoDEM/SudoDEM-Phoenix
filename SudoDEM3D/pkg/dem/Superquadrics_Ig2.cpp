...
)
{
	...
	for (;;) {
		...
		if (nfunc >= NMAX) throw std::runtime_error("NMAX exceeded in Superquadrics optimization");	//this is for test. It should be removed in the final rutine.
		//nfunc += 2;
...
void Ig2_Superquadrics_Superquadrics_SuperquadricsGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_Superquadrics_Superquadrics_SuperquadricsGeom");
	pybind11::class_<Ig2_Superquadrics_Superquadrics_SuperquadricsGeom, IGeomFunctor, std::shared_ptr<Ig2_Superquadrics_Superquadrics_SuperquadricsGeom>> _classObj(_module, "Ig2_Superquadrics_Superquadrics_SuperquadricsGeom", "Create/update geometry of collision between 2 Superquadricss");
	_classObj.def(pybind11::init<>());
}

void Ig2_Superquadrics_Superquadrics_SuperquadricsGeom2::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_Superquadrics_Superquadrics_SuperquadricsGeom2");
	pybind11::class_<Ig2_Superquadrics_Superquadrics_SuperquadricsGeom2, IGeomFunctor, std::shared_ptr<Ig2_Superquadrics_Superquadrics_SuperquadricsGeom2>> _classObj(_module, "Ig2_Superquadrics_Superquadrics_SuperquadricsGeom2", "Create/update geometry of collision between 2 Superquadricss");
	_classObj.def(pybind11::init<>());
}

void Ig2_Wall_Superquadrics_SuperquadricsGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_Wall_Superquadrics_SuperquadricsGeom");
	pybind11::class_<Ig2_Wall_Superquadrics_SuperquadricsGeom, IGeomFunctor, std::shared_ptr<Ig2_Wall_Superquadrics_SuperquadricsGeom>> _classObj(_module, "Ig2_Wall_Superquadrics_SuperquadricsGeom", "Create/update geometry of collision between Wall and Superquadrics");
	_classObj.def(pybind11::init<>());
}

void Ig2_Wall_Superquadrics_SuperquadricsGeom2::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_Wall_Superquadrics_SuperquadricsGeom2");
	pybind11::class_<Ig2_Wall_Superquadrics_SuperquadricsGeom2, IGeomFunctor, std::shared_ptr<Ig2_Wall_Superquadrics_SuperquadricsGeom2>> _classObj(_module, "Ig2_Wall_Superquadrics_SuperquadricsGeom2", "Create/update geometry of collision between Wall and Superquadrics");
	_classObj.def(pybind11::init<>());
}

void Ig2_Facet_Superquadrics_SuperquadricsGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_Facet_Superquadrics_SuperquadricsGeom");
	pybind11::class_<Ig2_Facet_Superquadrics_SuperquadricsGeom, IGeomFunctor, std::shared_ptr<Ig2_Facet_Superquadrics_SuperquadricsGeom>> _classObj(_module, "Ig2_Facet_Superquadrics_SuperquadricsGeom", "Create/update geometry of collision between Facet and Superquadrics");
	_classObj.def(pybind11::init<>());
}
