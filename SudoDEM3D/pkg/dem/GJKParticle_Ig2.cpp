#include <sudodem/pkg/dem/GJKParticle_Ig2.hpp>
#include <cmath>
...
// pyRegisterClass implementation moved from GJKParticle_Ig2.hpp
void Ig2_GJKParticle_GJKParticle_GJKParticleGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_GJKParticle_GJKParticle_GJKParticleGeom");
	pybind11::class_<Ig2_GJKParticle_GJKParticle_GJKParticleGeom, IGeomFunctor, std::shared_ptr<Ig2_GJKParticle_GJKParticle_GJKParticleGeom>> _classObj(_module, "Ig2_GJKParticle_GJKParticle_GJKParticleGeom", "Create/update geometry of collision between 2 GJKParticles");
	_classObj.def(pybind11::init<>());
}

// pyRegisterClass implementation moved from GJKParticle_Ig2.hpp
void Ig2_Wall_GJKParticle_GJKParticleGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_Wall_GJKParticle_GJKParticleGeom");
	pybind11::class_<Ig2_Wall_GJKParticle_GJKParticleGeom, IGeomFunctor, std::shared_ptr<Ig2_Wall_GJKParticle_GJKParticleGeom>> _classObj(_module, "Ig2_Wall_GJKParticle_GJKParticleGeom", "Create/update geometry of collision between Wall and GJKParticle");
	_classObj.def(pybind11::init<>());
}

// pyRegisterClass implementation moved from GJKParticle_Ig2.hpp
void Ig2_Facet_GJKParticle_GJKParticleGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_Facet_GJKParticle_GJKParticleGeom");
	pybind11::class_<Ig2_Facet_GJKParticle_GJKParticleGeom, IGeomFunctor, std::shared_ptr<Ig2_Facet_GJKParticle_GJKParticleGeom>> _classObj(_module, "Ig2_Facet_GJKParticle_GJKParticleGeom", "Create/update geometry of collision between Facet and GJKParticle");
	_classObj.def(pybind11::init<>());
}
