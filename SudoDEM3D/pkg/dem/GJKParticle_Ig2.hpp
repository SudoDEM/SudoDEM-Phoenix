...
REGISTER_SERIALIZABLE_BASE(Ig2_GJKParticle_GJKParticle_GJKParticleGeom, IGeomFunctor);
...
REGISTER_SERIALIZABLE_BASE(Ig2_Wall_GJKParticle_GJKParticleGeom, IGeomFunctor);
...
REGISTER_SERIALIZABLE_BASE(Ig2_Facet_GJKParticle_GJKParticleGeom, IGeomFunctor);
#endif
