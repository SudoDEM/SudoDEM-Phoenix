...
#include<sudodem/pkg/dem/HertzMindlin.hpp>
#include<sudodem/pkg/dem/ScGeom.hpp>
#include<sudodem/core/Omega.hpp>
#include<sudodem/core/Scene.hpp>

REGISTER_CLASS_INDEX_CPP(MindlinPhys,FrictPhys)
REGISTER_CLASS_INDEX_CPP(MindlinCapillaryPhys,MindlinPhys)
...
void MindlinPhys::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("MindlinPhys");
	pybind11::class_<MindlinPhys, FrictPhys, std::shared_ptr<MindlinPhys>> _classObj(_module, "MindlinPhys", "Representation of an interaction of the Hertz-Mindlin type");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("kno", &MindlinPhys::kno, "Constant value in the formulation of the normal stiffness");
	_classObj.def_readwrite("kso", &MindlinPhys::kso, "Constant value in the formulation of the tangential stiffness");
	_classObj.def_readwrite("kr", &MindlinPhys::kr, "Rotational stiffness");
	_classObj.def_readwrite("ktw", &MindlinPhys::ktw, "Rotational stiffness");
	_classObj.def_readwrite("maxBendPl", &MindlinPhys::maxBendPl, "Coefficient to determine the maximum plastic moment");
	_classObj.def_readwrite("adhesionForce", &MindlinPhys::adhesionForce, "Force of adhesion as predicted by DMT");
	_classObj.def_readwrite("isAdhesive", &MindlinPhys::isAdhesive, "bool to identify if the contact is adhesive");
	_classObj.def_readwrite("isSliding", &MindlinPhys::isSliding, "check if the contact is sliding");
	_classObj.def_readwrite("betan", &MindlinPhys::betan, "Normal Damping Ratio");
	_classObj.def_readwrite("betas", &MindlinPhys::betas, "Shear Damping Ratio");
	_classObj.def_readwrite("alpha", &MindlinPhys::alpha, "Constant coefficient to define contact viscous damping");
}

void Ip2_FrictMat_FrictMat_MindlinPhys::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ip2_FrictMat_FrictMat_MindlinPhys");
	pybind11::class_<Ip2_FrictMat_FrictMat_MindlinPhys, IPhysFunctor, std::shared_ptr<Ip2_FrictMat_FrictMat_MindlinPhys>> _classObj(_module, "Ip2_FrictMat_FrictMat_MindlinPhys", "Calculate physical parameters for Hertz-Mindlin formulation");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("gamma", &Ip2_FrictMat_FrictMat_MindlinPhys::gamma, "Surface energy parameter");
	_classObj.def_readwrite("eta", &Ip2_FrictMat_FrictMat_MindlinPhys::eta, "Coefficient to determine the plastic bending moment");
	_classObj.def_readwrite("krot", &Ip2_FrictMat_FrictMat_MindlinPhys::krot, "Rotational stiffness for moment contact law");
	_classObj.def_readwrite("ktwist", &Ip2_FrictMat_FrictMat_MindlinPhys::ktwist, "Torsional stiffness for moment contact law");
	_classObj.def_readwrite("constantkn", &Ip2_FrictMat_FrictMat_MindlinPhys::constantkn, "normal contact stiffness for particle-wall contacts");
	_classObj.def_readwrite("constantks", &Ip2_FrictMat_FrictMat_MindlinPhys::constantks, "tangent contact stiffness for particle-wall contacts");
	_classObj.def_readwrite("en", &Ip2_FrictMat_FrictMat_MindlinPhys::en, "Normal coefficient of restitution");
	_classObj.def_readwrite("es", &Ip2_FrictMat_FrictMat_MindlinPhys::es, "Shear coefficient of restitution");
	_classObj.def_readwrite("betan", &Ip2_FrictMat_FrictMat_MindlinPhys::betan, "Normal viscous damping ratio");
	_classObj.def_readwrite("betas", &Ip2_FrictMat_FrictMat_MindlinPhys::betas, "Shear viscous damping ratio");
	_classObj.def_readwrite("frictAngle", &Ip2_FrictMat_FrictMat_MindlinPhys::frictAngle, "Instance of MatchMaker for friction angle");
}

void Law2_ScGeom_MindlinPhys_MindlinDeresiewitz::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Law2_ScGeom_MindlinPhys_MindlinDeresiewitz");
	pybind11::class_<Law2_ScGeom_MindlinPhys_MindlinDeresiewitz, LawFunctor, std::shared_ptr<Law2_ScGeom_MindlinPhys_MindlinDeresiewitz>> _classObj(_module, "Law2_ScGeom_MindlinPhys_MindlinDeresiewitz", "Hertz-Mindlin contact law with partial slip solution");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("neverErase", &Law2_ScGeom_MindlinPhys_MindlinDeresiewitz::neverErase, "Keep interactions even if particles go away from each other");
}

void Law2_ScGeom_MindlinPhys_HertzWithLinearShear::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Law2_ScGeom_MindlinPhys_HertzWithLinearShear");
	pybind11::class_<Law2_ScGeom_MindlinPhys_HertzWithLinearShear, LawFunctor, std::shared_ptr<Law2_ScGeom_MindlinPhys_HertzWithLinearShear>> _classObj(_module, "Law2_ScGeom_MindlinPhys_HertzWithLinearShear", "Hertz formulation with linear shear");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("neverErase", &Law2_ScGeom_MindlinPhys_HertzWithLinearShear::neverErase, "Keep interactions even if particles go away from each other");
	_classObj.def_readwrite("nonLin", &Law2_ScGeom_MindlinPhys_HertzWithLinearShear::nonLin, "Shear force nonlinearity");
}

void Law2_ScGeom_MindlinPhys_Mindlin::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Law2_ScGeom_MindlinPhys_Mindlin");
	pybind11::class_<Law2_ScGeom_MindlinPhys_Mindlin, LawFunctor, std::shared_ptr<Law2_ScGeom_MindlinPhys_Mindlin>> _classObj(_module, "Law2_ScGeom_MindlinPhys_Mindlin", "Constitutive law for the Hertz-Mindlin formulation");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("preventGranularRatcheting", &Law2_ScGeom_MindlinPhys_Mindlin::preventGranularRatcheting, "bool to avoid granular ratcheting");
	_classObj.def_readwrite("includeAdhesion", &Law2_ScGeom_MindlinPhys_Mindlin::includeAdhesion, "bool to include the adhesion force following the DMT formulation");
	_classObj.def_readwrite("calcEnergy", &Law2_ScGeom_MindlinPhys_Mindlin::calcEnergy, "bool to calculate energy terms");
	_classObj.def_readwrite("includeMoment", &Law2_ScGeom_MindlinPhys_Mindlin::includeMoment, "bool to consider rolling resistance");
	_classObj.def_readwrite("neverErase", &Law2_ScGeom_MindlinPhys_Mindlin::neverErase, "Keep interactions even if particles go away from each other");
	_classObj.def("contactsAdhesive",&Law2_ScGeom_MindlinPhys_Mindlin::contactsAdhesive,"Compute total number of adhesive contacts.");
	_classObj.def("ratioSlidingContacts",&Law2_ScGeom_MindlinPhys_Mindlin::ratioSlidingContacts,"Return the ratio between the number of contacts sliding to the total number at a given time.");
	_classObj.def("normElastEnergy",&Law2_ScGeom_MindlinPhys_Mindlin::normElastEnergy,"Compute normal elastic potential energy.");
}
