...
class Element: public Serializable{
	public:
		...
		inline static constexpr Element::id_t ID_NONE = -1;
		...
		//! Default constructor
		Element() : id(Element::ID_NONE), pos(Vector3r::Zero()), ori(Quaternionr::Identity()) {}

		//! Python constructor
		static std::shared_ptr<Element> create() { return std::make_shared<Element>(); }

		SUDODEM_PYREGISTER_CLASS_API virtual void pyRegisterClass(pybind11::module_ _module) override;

		REGISTER_ATTRIBUTES(Serializable, id, pos, ori);
};
