...
class Node: public Serializable{
	public:
		...
		inline static constexpr Node::id_t ID_NONE = -1;
		...
		//! Default constructor
		Node() : id(Node::ID_NONE), groupMask(1), flags(FLAG_BOUNDED), pos(Vector3r::Zero()), vel(Vector3r::Zero()), angVel(Vector3r::Zero()), inertia(Vector3r::Zero()), mass(0), refPos(Vector3r::Zero()), ori(Quaternionr::Identity()), blockedDOFs(0), isDamped(true), iterBorn(-1), timeBorn(-1) {}
		...
		REGISTER_ATTRIBUTES(Serializable, id, groupMask, flags, pos, vel, angVel, inertia, mass, refPos, ori, blockedDOFs, isDamped, iterBorn, timeBorn);
};
