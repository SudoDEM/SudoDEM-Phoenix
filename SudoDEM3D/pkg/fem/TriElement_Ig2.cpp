...
*************************************************************************/
#include <sudodem/pkg/fem/TriElement_Ig2.hpp>
...
void Ig2_TriElement_Sphere_ScGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_TriElement_Sphere_ScGeom");
	pybind11::class_<Ig2_TriElement_Sphere_ScGeom, IGeomFunctor, std::shared_ptr<Ig2_TriElement_Sphere_ScGeom>> _classObj(_module, "Ig2_TriElement_Sphere_ScGeom", "Create/update a ScGeom instance representing intersection of TriElement and Sphere.");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("shrinkFactor", &Ig2_TriElement_Sphere_ScGeom::shrinkFactor, "The radius of the inscribed circle of the facet is decreased by the value of the sphere's radius multipled by shrinkFactor.");
}

void Ig2_TriElement_PolySuperellipsoid_ScGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_TriElement_PolySuperellipsoid_ScGeom");
	pybind11::class_<Ig2_TriElement_PolySuperellipsoid_ScGeom, IGeomFunctor, std::shared_ptr<Ig2_TriElement_PolySuperellipsoid_ScGeom>> _classObj(_module, "Ig2_TriElement_PolySuperellipsoid_ScGeom", "Create/update a ScGeom instance representing intersection of TriElement and PolySuperellipsoid.");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("shrinkFactor", &Ig2_TriElement_PolySuperellipsoid_ScGeom::shrinkFactor, "The radius of the inscribed circle of the facet is decreased by the value of the sphere's radius multipled by shrinkFactor.");
}

void Ip2_RolFrictMat_PolySuperellipsoidMat_FrictPhys::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ip2_RolFrictMat_PolySuperellipsoidMat_FrictPhys");
	pybind11::class_<Ip2_RolFrictMat_PolySuperellipsoidMat_FrictPhys, IPhysFunctor, std::shared_ptr<Ip2_RolFrictMat_PolySuperellipsoidMat_FrictPhys>> _classObj(_module, "Ip2_RolFrictMat_PolySuperellipsoidMat_FrictPhys", "Create a FrictPhys from two RolFrictMat and PolySuperellipsoidMat.");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("frictAngle", &Ip2_RolFrictMat_PolySuperellipsoidMat_FrictPhys::frictAngle, "Instance of MatchMaker determining how to compute interaction's friction angle.");
}

void Ig2_TriElement_GJKParticle_ScGeom::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ig2_TriElement_GJKParticle_ScGeom");
	pybind11::class_<Ig2_TriElement_GJKParticle_ScGeom, IGeomFunctor, std::shared_ptr<Ig2_TriElement_GJKParticle_ScGeom>> _classObj(_module, "Ig2_TriElement_GJKParticle_ScGeom", "Create/update a ScGeom instance representing intersection of TriElement and GJKParticle.");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("shrinkFactor", &Ig2_TriElement_GJKParticle_ScGeom::shrinkFactor, "The radius of the inscribed circle of the facet is decreased by the value of the sphere's radius multipled by shrinkFactor.");
}

void Ip2_RolFrictMat_GJKParticleMat_FrictPhys::pyRegisterClass(pybind11::module_ _module) {
	checkPyClassRegistersItself("Ip2_RolFrictMat_GJKParticleMat_FrictPhys");
	pybind11::class_<Ip2_RolFrictMat_GJKParticleMat_FrictPhys, IPhysFunctor, std::shared_ptr<Ip2_RolFrictMat_GJKParticleMat_FrictPhys>> _classObj(_module, "Ip2_RolFrictMat_GJKParticleMat_FrictPhys", "Create a FrictPhys from two RolFrictMat and GJKParticleMat.");
	_classObj.def(pybind11::init<>());
	_classObj.def_readwrite("frictAngle", &Ip2_RolFrictMat_GJKParticleMat_FrictPhys::frictAngle, "Instance of MatchMaker determining how to compute interaction's friction angle.");
}
